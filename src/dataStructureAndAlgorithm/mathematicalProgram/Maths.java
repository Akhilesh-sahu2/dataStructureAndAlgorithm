...
public class Maths {
	 ...
	 * Therefore, the condition of being a prime can also be restated as: 
	 * a number is prime if it is greater than one and if none of 2, 3, …, n-1 divides n (without remainder).
	...
	/**
	 * Reversing a number 
	 * example number = 123 to reverse
	 *    reverse = 0;
	 * 1. reverse = reverse * 10 , reverse=0;
	 *    reverse = reverse + number mod 10, reverse = 3;
	 *    number = number/10, number =12;
	 * 2. reverse = reverse * 10 , reverse=30;
	 *    reverse = reverse + number mod 10, reverse = 32;
	 *    number = number/10, number =1;
	 * 3. reverse = reverse * 10 , reverse=320;
	 *    reverse = reverse + number mod 10, reverse = 321;
	...
	public void swapNumber(int number1,int number2) {
		System.out.println("\tNumber to be swap is number1: "+number1+" and number2: "+number2+"\n");
